  ...
  return (
    <aside className="not-prose my-14 overflow-hidden rounded-[14px] border border-rule bg-cream-warm shadow-brand-sm">
      <div className="grid gap-6 p-6 sm:grid-cols-[120px_1fr] sm:items-center sm:gap-8 sm:p-8">
        ...
        <div>
          <span className="inline-flex items-center gap-1.5 font-body text-[0.76rem] font-bold uppercase tracking-[0.14em] text-rust">
          ...
          <h3 className="mt-2 font-display text-[1.35rem] font-medium leading-[1.2] text-ink sm:text-[1.5rem]">
            ...
            {title && (
              <span className="ml-2 font-body text-[0.92rem] font-semibold uppercase tracking-[0.12em] text-muted">
                · {title}
              </span>
            )}
          </h3>
          <p className="mt-2 text-[1.02rem] leading-[1.6] text-muted">
          ...
          <Link
            href="/about-us"
            className="mt-4 inline-flex items-center gap-2 font-body text-[1.02rem] font-bold text-rust transition-transform hover:translate-x-1"
          >
    ...
    <aside className="not-prose relative my-14 overflow-hidden rounded-[14px] border border-ink bg-ink text-cream">
      ...
      <div className="relative flex flex-col items-center gap-5 p-8 text-center md:flex-row md:items-center md:justify-between md:gap-8 md:p-9 md:text-left">
        <div className="max-w-[38ch]">
          <span className="inline-flex items-center gap-2 rounded-full border border-gold/25 bg-white/[0.04] px-3 py-1 font-body text-[0.74rem] font-bold uppercase tracking-[0.14em] text-gold">
            <span
              aria-hidden
        ...
        <div className="flex flex-col gap-3 sm:flex-row md:flex-shrink-0">
          <a
            href={phoneHref ?? "tel:"}
            className="inline-flex items-center justify-center gap-2.5 rounded-md bg-rust px-5 py-3.5 font-body text-[1.02rem] font-bold text-white shadow-[0_4px_14px_rgba(173,82,7,0.32)] transition-all hover:-translate-y-px hover:bg-rust-hover"
          >
            <span aria-hidden>✆</span>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-md border-[1.5px] border-white/25 bg-white/[0.03] px-5 py-3.5 font-body text-[1.02rem] font-bold text-cream backdrop-blur-sm transition-all hover:-translate-y-px hover:border-gold hover:text-gold"
          >
            Book online
            <span aria-hidden>→</span>
          </Link>
    ...
    <aside className="not-prose my-14 rounded-[14px] border border-rule bg-paper p-6 shadow-brand-sm sm:p-8">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {results.slice(0, 6).map((r, i) => (
          ...
          >
            <span className="font-body text-[0.76rem] font-bold uppercase tracking-[0.1em] text-muted">
              {r.charge}
            </span>
            <span className="inline-flex w-fit rounded-full border border-rust bg-rust/[0.08] px-2.5 py-1 font-body text-[0.74rem] font-bold uppercase tracking-[0.08em] text-rust">
              {r.outcomeLabel}
            </span>
            {r.jurisdiction && (
              <span className="pt-1 text-[0.8rem] text-muted">
                {r.jurisdiction}
                {r.year && ` · ${r.year}`}
              </span>
            )}
            <span
              aria-hidden
              className="mt-auto inline-flex items-center gap-1 pt-1 text-[0.8rem] font-semibold text-rust transition-transform group-hover:translate-x-1"
            >
              Read case study →
            </span>
          </Link>
    ...
    <aside className="not-prose my-14 overflow-hidden rounded-[14px] border border-rule bg-paper shadow-brand-sm">
      <div className="grid gap-0 md:grid-cols-[1.15fr_1fr]">
        ...
        <div className="border-b border-rule p-6 sm:p-8 md:border-b-0 md:border-r">
          ...
          <p className="mt-3 font-body text-[0.98rem] font-semibold uppercase tracking-[0.14em] text-muted">
        ...
        <div className="flex flex-col justify-center gap-4 bg-cream-warm/40 p-6 sm:p-8">
          <p className="text-[1.02rem] leading-[1.6] text-muted">
          ...
          {reviewsUrl ? (
            <a
              ...
              className="inline-flex w-fit items-center gap-2 rounded-md bg-rust px-5 py-3 font-body text-[1.02rem] font-bold text-white shadow-[0_4px_14px_rgba(173,82,7,0.28)] transition-all hover:-translate-y-px hover:bg-rust-hover"
            >
