              ...
              >
                <div className="flex flex-col">
                  ...
                  {(r.jurisdiction || r.year) && (
                    <span className="mt-1 flex items-center gap-1.5 text-[0.72rem] text-muted/80">
                      {r.jurisdiction}
                ...
                <span
                  className={`inline-flex whitespace-nowrap justify-self-start rounded-full border px-3 py-1.5 font-body text-[0.7rem] font-bold uppercase tracking-[0.08em] md:justify-self-end ${style.border} ${style.text} ${style.bg}`}
                >
                  {r.outcomeLabel}
                </span>
              </div>
