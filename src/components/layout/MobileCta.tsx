...
export function MobileCta() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex gap-2.5 border-t border-rule bg-paper px-4 py-2.5 shadow-[0_-4px_20px_rgba(11,10,31,0.1)] sm:hidden">
      <a
        href={phoneHref ?? "tel:"}
        className="flex flex-1 items-center justify-center gap-2 rounded-md bg-ink px-4 py-3 text-[0.88rem] font-bold text-cream transition-all hover:bg-ink-soft"
      >
        ✆ Call
      </a>
      <Link
